  ...
  return (
    <section>
      <article className="text-lg">
        ...
        I&apos;m not wrangling TypeScript or tweaking PostgreSQL queries,
        you&apos;ll find me experimenting with side projects, jamming to music,
        or catching sunsets with chai in hand. Let&apos;s build something people
